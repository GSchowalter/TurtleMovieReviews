      ...
      <div className={styles.aboutus_container}>
        ...
        <div className={styles.row}>
          ...
          <p>
            ...
            will be worth their time. Entertainment requires commitment and it
            is our thinking that you shouldn't have to waist your time with
            movies and shows that aren't worth watching. Use us as a guide to
            help you find the quality in the sea of mediocrity.
          </p>
        </div>
        <div className={styles.row}>
          <h2>Socials</h2>
